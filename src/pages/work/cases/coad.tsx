...
export default function Coad() {
  return (
    <Layout>
      <Hero description={<div className="w-[92%] mx-auto max-w-main pt-[100px] flex items-center justify-end">
        ...
        <div className="flex items-center mb-[50px] gap-[50px]">
          <div>
            <h1 className="text-main font-[500]">Kunde</h1>
            <p className="text-gray-600 font-[400]">COAD</p>
          </div>
          <div>
            <h1 className="text-main font-[500]">Ydelse</h1>
            <p className="text-gray-600 font-[400]">Hjemmeside</p>
          </div>
        </div>
        
        </span>Gazella Team udgør et hold af ambitiøse, nytænkende og storsmilende programmøre og designere, som hver dag brænder for at skabe unikke digitale produkter. Vi fokuserer på, at tilpasse hver enkel løsning til det pågældende projekt. Derfor kan du hos os forvente en fast kompetent sparingspartner, som supplerer med viden og leverer til tiden til den aftalte pris.
            </p>
