        ...
        <Link href={href || '/blog'} passHref>
            ...
            <article className="flex flex-col md:flex-row gap-4 md:gap-8 md:items-center group rounded-lg transition-all">
                <div className="flex-1 relative overflow-hidden rounded-lg">
                    <img
                        alt="Blog"
                        className="w-full h-auto object-cover rounded-lg group-hover:scale-105 transition-all"
                        src={image}
                    />
                    {/*
                ...
                <div className="flex flex-col flex-1 gap-2">
                    ...
                    <p className="hidden md:inline pt-4 pb-4 text-gray-700 text-sm lg:text-base">
                        {summary}
                    </p>
