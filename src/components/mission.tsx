export default function Mission() {
    return (
        <section className="py-[70px] mb-[100px]">
            <div className="w-[90%] mx-auto max-w-[730px] text-main">
                <h1 className="text-[40px] font-[500] mb-[40px] leading-[50px] mid:text-[40px] mid:leading-[40px]">We help you achieve digital success through innovative software.</h1>
